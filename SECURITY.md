...
To document a security concern, communication is facilitated with the project curator:
  ...
  - **Method**: Reports are submitted via the repository’s [GitHub Issues](https://github.com/Amey-Thakur/LATEXRENDER/issues) interface to formally record security-related findings.
