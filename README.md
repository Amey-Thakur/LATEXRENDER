<div align="center">
  ...
  **[Source Code](Source%20Code/)** &nbsp;·&nbsp; **[Technical Specification](docs/SPECIFICATION.md)** &nbsp;·&nbsp; **[Live Demo](https://amey-thakur.github.io/LATEXRENDER/)**
  ...
  <a href="https://amey-thakur.github.io/LATEXRENDER/">
    <img src="Source Code/assets/screenshots/social_identity_preview.png" alt="LaTeX Render" title="Sovereign Mathematical Rendering Engine: LATEXRENDER Social Identity and Branding" width="90%">
  </a>
...
│
├── Source Code/assets/screenshots/      # High-fidelity visual verification gallery
...
<h2>Results</h2>
  ...
  <br><br>
  <img src="Source Code/assets/screenshots/social_identity_preview.png" alt="Social Identity" title="Sovereign Mathematical Rendering Engine: LATEXRENDER Social Identity and Branding" width="90%">
  <br><br><br>
  ...
  <br><br>
  <img src="Source Code/assets/screenshots/application_interface.png" alt="Application Interface" title="LATEXRENDER Workspace: High-Performance Autonomous Mathematical Interface" width="90%">
  <br><br><br>
  ...
  <br><br>
  <img src="Source Code/assets/screenshots/attention_mechanism_equation.png" alt="Attention Formula" title="Real-Time TeX-to-HTML: High-Fidelity Mathematical Expression Rendering" width="90%">
  <br><br><br>
  ...
  <br><br>
  <img src="Source Code/assets/screenshots/math_symbol_palette.png" alt="Symbol Palette" title="Interactive Symbol Library: Intelligent Cursor-Aware TeX Insertion" width="60%">
  <br><br><br>
  ...
  <br><br>
  <img src="Source Code/assets/screenshots/recent_history_tracking.png" alt="History Matrix" title="Session Persistence: Localized Equation History and State Tracking" width="60%">
  <br><br><br>
  ...
  <br><br>
  <img src="Source Code/assets/screenshots/attention_formula_output.png" alt="Output Sample" title="Production-Grade Binary Export: Multi-Format High-Fidelity Result Verification" width="60%">
  <br><br><br>
  ...
  <br><br>
  <img src="Source Code/assets/screenshots/attention_mechanism_variant.png" alt="Structural Verification" title="Multimodal Rendering Verification: Mathematical Engine Structural Outcome Analysis" width="90%">
</div>
